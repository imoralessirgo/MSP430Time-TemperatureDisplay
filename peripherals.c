...
void BuzzerOn(unsigned int freq)
{
    ...
    TB0CCR0   = freq/500;                    // Set the PWM period in ACLK ticks
...
unsigned int readBtns(void)
{
    // Reads Button states and returns the button being pressed
    //
    // Input: none
